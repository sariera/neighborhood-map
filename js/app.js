...
var locations = [{
        ...
        {
          title: 'Ali Baba International Centre',
          location: {
            lat: 32.0149537,
            lng: 35.868284
          }
        ...
        {
          title: 'King Hussein Cancer Center',
          location: {
            lat: 32.0046864,
            lng: 35.8751055
          }
...
function ViewModel() {
    self = this;
    this.cityName = ko.observable("Amman, Jordan");
...
function initMap() {
    ...
    // var autoCompleteName = new google.maps.places.Autocomplete(
